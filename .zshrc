...
# default java path and version management commands
JAVA_HOME=~/.java/jdk-24.jdk/Contents/Home
jenv() { export JAVA_HOME=$(/usr/libexec/java_home -v $1) && echo $JAVA_HOME }
